  ...
  <div id="statsContainer">
    <div class="stats">
      <div class="side-panel left-panel">
        <div id="graphSelectionOverlay"></div>
        <div>
          <h2 id="graphSelectionTitle">Rapports Disponibles</h2>
          <div class="graph-list">
            <div class="graph-item selected-item">
              <div class="item-title">
                <div>Sommaire des ventes</div>
                <div>Par événement</div>
              </div>
              <div>
                <div>Période : 2018-10 &#8213; 2019-02</div>
                <div class="download-btn">Télécharger</div>
              </div>
            </div>
            <div class="graph-item">
              <div class="item-title">
                <div>Sommaire de l'assistance</div>
                <div>Par événement</div>
              </div>
              <div>
                <div>Période : 2018-10 &#8213; 2019-02</div>
